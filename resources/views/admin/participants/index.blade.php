        ...
        <div class="row">
            <div class="col-md-6">
                ...
                @can('participant_create')
                    <p>
                        <a href="{{ route('admin.participants.create') }}" class="btn btn-success">@lang('quickadmin.qa_add_new')</a>
        ...
        <div class="col-md-6 pull-right">
            <div class="box box-success">
                ...
                <div class="box-body">
                    ...
                    <form class="md-form" method="post" action="{{route('admin.trainings.import')}}" enctype="multipart/form-data">
                        {{ csrf_field() }}
