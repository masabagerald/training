...
@section('content')
    ...
    {!! Form::model($participant, ['method' => 'PUT', 'route' => ['admin.participants.update', $participant->id], 'files' => true,]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::hidden('physical_addr_latitude', $participant->physical_addr_latitude , ['id' => 'physical_addr-latitude']) !!}
                    {!! Form::hidden('physical_addr_longitude', $participant->physical_addr_longitude , ['id' => 'physical_addr-longitude']) !!}
                    <p class="help-block"></p>
                ...
                <div class="col-xs-12 form-group">
                    ...
                    <div class="photo-block">
                        ...
                        <div class="files-list">
                            @foreach($participant->getMedia('documents') as $media)
                                <p class="form-group">
                                    <a href="{{ $media->getUrl() }}" target="_blank">{{ $media->name }} ({{ $media->size }} KB)</a>
                                    <a href="#" class="btn btn-xs btn-danger remove-file">Remove</a>
                                    <input type="hidden" name="documents_id[]" value="{{ $media->id }}">
                                </p>
                            @endforeach
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    @if ($participant->photo)
                        <a href="{{ asset(env('UPLOAD_PATH').'/'.$participant->photo) }}" target="_blank"><img src="{{ asset(env('UPLOAD_PATH').'/thumb/'.$participant->photo) }}"></a>
                    @endif
