                           ...
                           <form id="a_form" method="POST" >
                               ...
                               <div class="row">
                                       ...
                                       <div class="col-md-6  form-group">
                                           ...
                                           <input type="text" name="a_training" id="a_training" class="form-control" placeholder="training" readonly>
                                       </div>
                                   <input type="hidden" name="id" id="a_hidden" >
                               ...
                               <div class="row">
                                   ...
                                   <div class="col-md-6">
                                       <button type="button" class="btn btn-instagram" id="a_submit" onclick="attachParticipant()">
                                           Submit
                                       </button>
                                   </div>
                               </div>
