...
@section('content')
    ...
    {!! Form::model($training, ['method' => 'PUT', 'route' => ['admin.trainings.update', $training->id], 'files' => true,]) !!}
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('title', trans('quickadmin.training.fields.title').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::text('type_of_training', old('type_of_training'), ['class' => 'form-control', 'placeholder' => '']) !!}
                    <p class="help-block"></p>
                ...
                <div class="col-xs-12 form-group">
                    ...
                    <div class="photo-block">
                        ...
                        <div class="files-list">
                            @foreach($training->getMedia('pictures') as $media)
                                <p class="form-group">
                                    <a href="{{ $media->getUrl() }}" target="_blank">{{ $media->name }} ({{ $media->size }} KB)</a>
                                    <a href="#" class="btn btn-xs btn-danger remove-file">Remove</a>
                                    <input type="hidden" name="pictures_id[]" value="{{ $media->id }}">
                                </p>
                            @endforeach
                        </div>
                    </div>
